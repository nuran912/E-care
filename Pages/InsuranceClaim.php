...
<html>
    <head>
        ...
        <link rel="stylesheet" href="../Style/InsuranceClaim.css">
    </head>
    ...
    <body>
        ...
        <script>
            function validateForm(event) {
                ...
                const fields = [
                    {id:'hospital',label:'Hospital',type:'select'},
                    {id:'insurance-company',label:'Insurance Company',type:'select'},
                    {id:'policy-holder-name',label:'Name of Policy Holder/Member'},
                    {id:'relationship',label:'Relationship to Policy Holder/Member'},
                    {id:'patient-full-name',label:"Patient's Full Name"},
                    {id:'email',label:'Email'},
                    {id:'claim-type',label:'Claim Type',type:'select'},
                    {id:'policy-number',label:'Policy Number'},
                    {id:'nic',label:'NIC of Policy Holder/Member'},
                    {id:'member-number',label:"Member Number"},
                    {id:'contact-number',label:"Policy Holder's Contact Number"},
